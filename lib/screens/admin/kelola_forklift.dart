  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Kelola Unit Forklift', style: AdminTheme.appBarTitle),
                                ...
                                ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: forklift['gambar'] != null
                                        ? CachedNetworkImage(
                                            imageUrl:
                                                'http://192.168.1.21:3000/images/${forklift['gambar']}',
                                            fit: BoxFit.cover,
                                            width: 110,
                                            height: 90,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage(
                          'http://192.168.1.21:3000/images/$_currentImageUrl'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
