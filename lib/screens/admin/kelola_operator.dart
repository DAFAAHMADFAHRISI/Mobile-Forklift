  ...
  Future<void> fetchOperators() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://10.251.130.195:3000/api/operator'),
        headers: {
  ...
  Future<void> _addOperator(String namaOperator, String noHp) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://10.251.130.195:3000/api/operator/store'),
        headers: {
          'Content-Type': 'application/json',
          if (token != null) 'Authorization': 'Bearer $token',
        },
  ...
  Future<void> _updateOperator(
    ...
    try {
      ...
      final response = await http.put(
        Uri.parse('http://10.251.130.195:3000/api/operator/edit/$id'),
        headers: {
          'Content-Type': 'application/json',
          if (token != null) 'Authorization': 'Bearer $token',
        },
  ...
  Future<void> _deleteOperator(int id) async {
    ...
    try {
      ...
      final response = await http.delete(
        Uri.parse('http://10.251.130.195:3000/api/operator/delete/$id'),
        headers: {
          'Content-Type': 'application/json',
          if (token != null) 'Authorization': 'Bearer $token',
        },
                            ...
                            leading: operator['foto'] != null &&
                                ...
                                ? CircleAvatar(
                                    backgroundImage: NetworkImage(
                                      'http://10.251.130.195:3000/uploads/operator/${operator['foto']}',
                                    ),
                                  )
